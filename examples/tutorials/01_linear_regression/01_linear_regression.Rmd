...
nodes given by a computional mesh, experimental data and a normalization error.
In the first step a *node_dt* datatable was created summarizing the information
about the nodes. In the second steps mappings were established between the nodes
on the basis of query operation on *node_dt*.
